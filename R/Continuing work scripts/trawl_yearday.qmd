...
seasonal_dist %>% 
  select(comname, est_year) %>% 
  distinct() %>% 
  mutate(yearID = est_year-1970 + 1) -> test

# test$est_year[test$comname == "american lobster"] == unique(seasonal_dist$est_year) loop this or function or something
